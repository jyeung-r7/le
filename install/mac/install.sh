...
FILES="le.py backports.py utils.py __init__.py metrics.py formats.py cacert.pem"
LE_PARENT="https://raw.githubusercontent.com/logentries/le/master/logentries/"
